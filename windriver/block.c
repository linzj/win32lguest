...
co_monitor_file_block_operations_t co_os_file_block_async_operations = {
	co_os_file_block_get_size,
	co_os_file_block_async_open, /* open */
	co_os_file_block_async_read,
	co_os_file_block_async_write,
	co_os_file_block_close,
};

co_monitor_file_block_operations_t co_os_file_block_default_operations = {
	co_os_file_block_get_size,
	co_os_file_block_open,
	co_os_file_block_read,
	co_os_file_block_write,
	co_os_file_block_close,
};
